...
TOPICS = {
    ...
    "facial_emotion_recognition": {"title": "Распознавание эмоций человека по лицу", "sim": None},
    "first_impression": {"title": "Техники первого впечатления", "sim": None},
    "pragmatics_model": {"title": "Двухэтапная модель прагматика", "sim": None},
    "photography_exposure": {"title": "Выдержка в фотографии и её контекст", "sim": "photography_exposure"},
    "network_drivers": {"title": "Сетевые драйверы", "sim": None},
    "low_level_cpp": {"title": "Низкоуровневый C++", "sim": None},
    "assembly": {"title": "Ассемблер", "sim": None},
    "performance_optimization": {"title": "Оптимизация производительности", "sim": None},
    "iso_standards": {"title": "ISO стандарты (менеджмент и ИТ)", "sim": None},
    "tiktok_algorithm": {"title": "TikTok: алгоритмы рекомендаций", "sim": None},
